export const de = {
    ...
    scout_roleGate_active: "Rollen-Check aktiv",
    scout_roleGate_partial: "Rollen-Check aktiv. Für einige Champions fehlen Referenzdaten.",
    scout_roleGate_unavailable:
        "Rollen-Check nicht verfügbar. Ban-Vorschläge können Champions enthalten, die auf der Lane kaum gespielt werden.",
    ...
    scout_roleGate_totalPicks: "Picks insgesamt: {picks}",
    scout_roleGate_thresholds: "Nötig wären mindestens {picks} Picks und {share}%.",
    scout_roleGate_primaryFallback: "Meistgespielte Lane dieses Champions.",
    scout_roleGate_notEvaluated_referenceMissing: "Nicht geprüft: keine Referenzdaten geladen.",
    scout_roleGate_notEvaluated_championMissing: "Nicht geprüft: Champion fehlt in den Referenzdaten.",
    scout_roleGate_notEvaluated_roleUnknown: "Nicht geprüft: dieser Spieler steht auf keiner Lane.",
    scout_roleGate_notEvaluated_sampleTooSmall:
        "Nicht geprüft: zu wenige Referenzdaten für diesen Champion.",
    scout_moreWeaknessesOne: "{count} weitere Schwäche anzeigen",
    scout_moreWeaknessesMany: "{count} weitere Schwächen anzeigen",
    scout_moreBansOne: "{count} weiteren Ban anzeigen",
    scout_moreBansMany: "{count} weitere Bans anzeigen",
    scout_moreThreatsOne: "{count} weitere Bedrohung anzeigen",
    scout_moreThreatsMany: "{count} weitere Bedrohungen anzeigen",
    scout_moreComfortOne: "{count} weiteren Comfort Pick anzeigen",
    scout_moreComfortMany: "{count} weitere Comfort Picks anzeigen",
    ...
    scout_banPhase_all: "Alle",
    scout_banPhase_safe: "Sicher",
    scout_banPhase_target: "Gezielt",
    scout_banPhase_situational: "Situativ",
    scout_banAffectedPlayers: "Betrifft: {players}",
    scout_banOverlapBadge: "Trifft {count} Spieler",
