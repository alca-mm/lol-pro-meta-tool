export const de = {
    ...
    scout_player_rank: "Rang",
    scout_player_rankUnknown: "Rang unbekannt",
    scout_player_sources: "Quellen",
    scout_player_sourceDetails: "Details zu den Quellen",
    scout_rank_unranked: "Ohne Rang",
    scout_rank_iron: "Eisen",
    scout_rank_bronze: "Bronze",
    scout_rank_silver: "Silber",
    scout_rank_gold: "Gold",
    scout_rank_platinum: "Platin",
    scout_rank_emerald: "Smaragd",
    scout_rank_diamond: "Diamant",
    scout_rank_master: "Meister",
    scout_rank_grandmaster: "Großmeister",
    scout_rank_challenger: "Herausforderer",
    ...
    scout_moreReasons: "Weitere Gründe",
    ...
    scout_reason_champion_not_playable_in_role:
        "{champion} wird auf {role} praktisch nicht gespielt. Der Eintrag bleibt erhalten, zählt aber nicht als Ban für diese Rolle.",
    scout_reason_high_rank_player: "Hoher Rang ({rank}), die Daten wiegen etwas schwerer.",
    ...
    scout_warning_flex_pick_warning: "{count} Champions tauchen auf mehreren Rollen auf. Ein Ban trifft dann eventuell nicht die Rolle, die du meinst.",
    scout_warning_flex_pick_warningOne: "{count} Champion taucht auf mehreren Rollen auf. Ein Ban trifft dann eventuell nicht die Rolle, die du meinst.",
    ...
    scout_warning_role_not_playable_filtered:
        "{count} Champions wurden nicht als Ban vorgeschlagen, weil sie auf der Lane des jeweiligen Spielers praktisch nicht gespielt werden.",
    scout_warning_role_not_playable_filteredOne:
        "{count} Champion wurde nicht als Ban vorgeschlagen, weil er auf der Lane dieses Spielers praktisch nicht gespielt wird.",
