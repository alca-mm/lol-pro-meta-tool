...
export const en: Translations = {
    ...
    scout_roleGate_active: "Role check active",
    scout_roleGate_partial: "Role check active. Some champions have no reference data.",
    scout_roleGate_unavailable:
        "Role check unavailable. Ban suggestions can include champions that are barely played on the lane.",
    ...
    scout_roleGate_totalPicks: "Picks in total: {picks}",
    scout_roleGate_thresholds: "It would take at least {picks} picks and {share}%.",
    scout_roleGate_primaryFallback: "This champion's most played lane.",
    scout_roleGate_notEvaluated_referenceMissing: "Not checked: no reference data loaded.",
    scout_roleGate_notEvaluated_championMissing: "Not checked: the champion is missing from the reference data.",
    scout_roleGate_notEvaluated_roleUnknown: "Not checked: this player holds no lane.",
    scout_roleGate_notEvaluated_sampleTooSmall:
        "Not checked: too little reference data for this champion.",
    scout_moreWeaknessesOne: "Show {count} more weakness",
    scout_moreWeaknessesMany: "Show {count} more weaknesses",
    scout_moreBansOne: "Show {count} more ban",
    scout_moreBansMany: "Show {count} more bans",
    scout_moreThreatsOne: "Show {count} more threat",
    scout_moreThreatsMany: "Show {count} more threats",
    scout_moreComfortOne: "Show {count} more comfort pick",
    scout_moreComfortMany: "Show {count} more comfort picks",
    ...
    scout_banPhase_all: "All",
    scout_banPhase_safe: "Safe",
    scout_banPhase_target: "Targeted",
    scout_banPhase_situational: "Situational",
    scout_banAffectedPlayers: "Affects: {players}",
    scout_banOverlapBadge: "Hits {count} players",
