...
export const en: Translations = {
    ...
    scout_player_rank: "Rank",
    scout_player_rankUnknown: "Unknown rank",
    scout_player_sources: "Sources",
    scout_player_sourceDetails: "Source details",
    scout_rank_unranked: "Unranked",
    scout_rank_iron: "Iron",
    scout_rank_bronze: "Bronze",
    scout_rank_silver: "Silver",
    scout_rank_gold: "Gold",
    scout_rank_platinum: "Platinum",
    scout_rank_emerald: "Emerald",
    scout_rank_diamond: "Diamond",
    scout_rank_master: "Master",
    scout_rank_grandmaster: "Grandmaster",
    scout_rank_challenger: "Challenger",
    ...
    scout_moreReasons: "More reasons",
    ...
    scout_reason_champion_not_playable_in_role:
        "{champion} is practically never played as {role}. The entry is kept, but it does not count as a ban for that role.",
    scout_reason_high_rank_player: "High rank ({rank}), so the data carries a little more weight.",
    ...
    scout_warning_flex_pick_warning: "{count} champions show up in several roles. A ban may not hit the role you have in mind.",
    scout_warning_flex_pick_warningOne: "{count} champion shows up in several roles. A ban may not hit the role you have in mind.",
    ...
    scout_warning_role_not_playable_filtered:
        "{count} champions are not suggested as bans, because they are practically never played on the lane their player is set to.",
    scout_warning_role_not_playable_filteredOne:
        "{count} champion is not suggested as a ban, because it is practically never played on the lane that player is set to.",
